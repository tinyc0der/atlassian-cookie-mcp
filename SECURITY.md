...
2. **Prefer extension Sync** - Native Messaging hands cookies to the local host (no Downloads). Auto-sync is **opt-in** and only reacts to session cookie changes for allowed hosts. Treat any leftover cookie JSON like a password.
